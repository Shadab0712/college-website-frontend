    ...
    return (
        <div>
            <div className="container">
                <h2 className='text-center mb-5'>Why choose Al Ibrahim Mahavidhyalaya ?</h2>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text className='text-center'>
                                    <ul className='text-left'>
                                        <li>Highly qualified and experienced teachers committed to student success.</li>
                                        <li>Faculty members with industry experience to provide practical insights.</li>
                                        <li>Regular professional development to keep faculty updated with the latest teaching methods.</li>
                                    </ul>
                                </Card.Text>
                            </Card.Body>
                    ...
                    <div className='col-lg-4'>
                        <Card className='d-flex align-items-center border-0 h-100'>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text className='text-center'>
                                    <ul className='text-left'>
                                        <li>A safe and secure campus with robust safety measures.</li>
                                        <li>A diverse and inclusive community welcoming students from various backgrounds.</li>
                                        <li>Policies promoting equality and non-discrimination.</li>
                                    </ul>
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    ...
                    <div className='col-lg-4'>
                        <Card className='d-flex align-items-center border-0 h-100'>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text className='text-center'>
                                    <ul className='text-left'>
                                        <li>Small class sizes to ensure individual attention.
                                        </li>
                                        <li>Personalized academic counseling and career guidance.
                                        </li>
                                        <li>Various clubs and societies to promote extracurricular activities and student engagement.</li>
                                    </ul>
                                </Card.Text>
                            </Card.Body>
                        </Card>
